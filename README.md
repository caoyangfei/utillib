...
* ### string.xml  html格式解析-> [HtmlParser.java][HtmlTagHandler.java]
## Simple
```
```xml
 <string name="device_style1"><![CDATA[<font color="#FFFFFF" size="15"><b>%1$s</b></font><font color="#FFFFFF" size="12">%2$s</font>]]></string>
```java
 String name = String.format(context.getString(R.string.device_style1), "string1" , "string2");
 textview.setText(HtmlParser.buildSpannedText(name, new HtmlTagHandler()));
```
